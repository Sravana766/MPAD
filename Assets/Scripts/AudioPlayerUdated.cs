...
//AudioPlayerUpdated Removes Audio mixers (& pitch shifting capabilities)
//More robust control of audio features, avoids clipping seen w/ mixers during PTA
public class AudioPlayerUpdated
{
    ...
    public AudioPlayerUpdated(AudioSource audioSource, float offsetAngle = 0.0f)
    {
