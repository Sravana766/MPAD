...
public class AudioPlayer
{
    ...
    {
        this.pitch = pitch;
        //NOTE: pitch must be an "exposed" value in the AudioMixer
    ...
    //To modify volume besides the 0-1 linear scale in Unity
    public void SetVolume(float inputtedVolume)
    {
        this.volume = inputtedVolume;

        //NOTE: volume must be an "exposed" value in the AudioMixer
        leftSource.outputAudioMixerGroup.audioMixer.SetFloat("Volume", inputtedVolume);
        rightSource.outputAudioMixerGroup.audioMixer.SetFloat("Volume", inputtedVolume);
    }
